...
#
# Examples:
#   tl_emit agent_start ticket=PROJ-997 run_id=r_8f2a mode=implementation pid=$$
#   tl_emit agent_end   ticket=PROJ-997 run_id=r_8f2a exit=ok seconds=1008
#   tl_emit jira_transition ticket=PROJ-997 from="In Progress" to="Code Review" source=agent
#   tl_emit mr_opened   ticket=PROJ-997 mr_iid=2022 project=ssr
#   tl_emit mr_approved ticket=PROJ-997 mr_iid=2022
#   tl_emit review_posted ticket=PROJ-997 mr_iid=2022 verdict=lgtm round=1 author_is_me=true
#
