...
A tracker driver speaks to the issue tracker (Jira, GitHub Issues, …).
...
Issues this means mapping labels. The shape of each result dict is fixed:
...
```
{
  ...
  "assignee":  "jane.doe", # handle or email; may be ""
