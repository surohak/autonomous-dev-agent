...
tl_emit agent_start ticket=PROJ-100 run_id=r_abc mode=dev pid=42 manual=1
...
# 2) Boolean coercion.
tl_emit review_posted ticket=PROJ-100 mr_iid=2022 author_is_me=true round=1
...
tl_emit jira_transition ticket=PROJ-100 from="In Progress" to="Code Review" source=agent
