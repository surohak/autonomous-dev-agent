...
# doesn't resurface it. Stored as JSON object { "UA-123:2026-04-15": "..." }.
_tempo_skip_add() {
...
# Dispatcher sends us the raw CMD string: "tm_log UA-997 2026-04-15 5400"
...
# "tm_edit UA-997 2026-04-15 5400" — opens a force-reply
handler_tm_edit() {
  local cmd="$1"
  local ticket date seconds
  ticket=$(awk '{print $2}' <<< "$cmd")
