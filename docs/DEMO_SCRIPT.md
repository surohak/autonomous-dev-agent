...
| 0:05    | Jira board: drag ticket UA-999 → "To Do"                                             | "Assign yourself a Jira ticket."     |
| 0:12    | Fast-forward 2 min (clock overlay) — SwiftBar icon goes ⏳ → 🤖                       | "2 min tick — agent picks it up."    |
| 0:20    | Telegram: inline card "UA-999: Add feedback toast" [Approve] [Skip] [Review scope]   | "Approve, skip, or review scope."    |
| 0:30    | Click [Approve]                                                                      |                                      |
...
| 1:10    | Telegram: "UA-999 → Ready for QA. Tempo? [Log 45m ▸ UA-999]"                         | "Tempo one-tap backfill."            |
